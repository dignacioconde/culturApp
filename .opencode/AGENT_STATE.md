...
- Ultima actualizacion: Consolidada leccion sobre bugs visuales/responsive: prompts con ruta, viewport, captura/sintoma, criterio visual; react-big-calendar requiere altura real en contenedor interno.
