...
| [[../issues/CACH-0092|CACH-0092]] | Feed suscribible privado de eventos | RELEASE-0.1.0-beta.24 | Implementación local añadida: migración `calendar_feeds`, RPCs `create_calendar_feed`, `revoke_calendar_feed` y `get_calendar_feed_events`, Edge Function pública `calendar-feed` y builder ICS testeado. |
...
| [[../issues/CACH-0094|CACH-0094]] | QA y cierre de Beta 24 calendario | RELEASE-0.1.0-beta.24 | QA local de Beta 24 completado. La app, Product Brain y smoke responsive pasan; migración y Edge Function quedan implementadas en repositorio pero no aplicadas/desplegadas en Supabase remoto. |
