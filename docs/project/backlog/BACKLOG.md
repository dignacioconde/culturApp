...
|---|---|---|---|---|
| [[../issues/CACH-B0020|CACH-B0020]] | Validar dominio de email transaccional y cambiar remitentes definitivos | chore | p0 | Bloqueada: falta dominio/remitente real con DNS público validable por Brevo. |
