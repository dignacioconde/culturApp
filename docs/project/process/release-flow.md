...
8. Tras mergear la PR, actualizar `main`, crear tag desde `main`, crear GitHub Release desde ese tag, confirmar que `/novedades` refleja la beta publicada si hay cambios visibles y borrar la rama remota de release.
