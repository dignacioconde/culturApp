...
`0.1` es el ciclo organizativo. `0.1.0-beta.13` queda reservado para la operativa manual de email definitivo tras la beta de codigo UX.
...
|---|---|---|---|
| [[../issues/CACH-B0020|CACH-B0020]] | Validar dominio de email transaccional y cambiar remitentes definitivos | In progress | `release/0.1.0-beta.13` |
...
- [ ] PR `release/0.1.0-beta.13` -> `main` abierta si hay cambios versionados
