  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center p-3 sm:items-center sm:p-4">
      ...
      <div
        ...
        className="relative flex max-h-[80dvh] sm:max-h-[90vh] w-full max-w-full md:max-w-2xl flex-col rounded-lg bg-white shadow-2xl ring-1 ring-[var(--color-ink)]/10 animate-scale-in"
      >
