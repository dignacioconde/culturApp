...
- For implementation work, the user expects a branch from up-to-date `main`, a PR targeting `main`, merge after passing checks, and production verification when the change should be visible in the published app.
